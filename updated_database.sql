...
create table public.profiles (
  ...
  producer_verified boolean null default false,
...
create table public.planted_crops (
  ...
  constraint planted_crops_crop_id_fkey foreign KEY (crop_id) references crops (id) on update CASCADE on delete set null,
