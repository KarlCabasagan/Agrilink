...
export const products = [
    {
        ...
        description: "Fresh organic carrots grown locally. Rich in beta-carotene and perfect for cooking or eating raw. These carrots are hand-picked and carefully selected for quality.",
        stock: 25,
        rating: 4.5,
        reviews: [
            { user: "John D.", rating: 5, comment: "Very fresh and crunchy!", date: "2025-08-30" },
            { user: "Maria S.", rating: 4, comment: "Good quality carrots", date: "2025-08-28" },
            { user: "Pedro L.", rating: 5, comment: "Best carrots in the area!", date: "2025-08-25" }
        ],
    },
    {
        id: 2,
        ...
        description: "Crisp and sweet apples perfect for snacking. Locally grown with no harmful pesticides.",
        stock: 18,
        rating: 4.2,
        reviews: [
            { user: "Anna M.", rating: 4, comment: "Sweet and crispy!", date: "2025-08-29" }
        ],
    },
    {
        id: 3,
        ...
        description: "Premium quality rice, perfect for daily meals. Well-milled and clean.",
        stock: 100,
        rating: 4.8,
        reviews: [
            { user: "Carlos R.", rating: 5, comment: "Best rice quality!", date: "2025-08-27" }
        ],
    },
    {
        id: 4,
        ...
        description: "High-quality mung beans, perfect for soup and other dishes.",
        stock: 12,
        rating: 4.3,
        reviews: [],
    },
